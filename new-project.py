...
spell2 = ['Cure Wounds', 'heal yourself, meduim healing', 5, 10, 3, 3]
...
while phase != 'game over':
    ...
    while phase == 'combat':
        ...
        if turn_picker < player_stats[0]:
            ...
            print(f'Your health is {player_stats[4]}/{player_stats[3]}')
            print(f'{monster_stats[5]} health is {monster_stats[4]}/{monster_stats[3]}')
            while turn == 'player':
        ...
        if player_stats[4] < 1:
            ...
            while turn == 'monster':
                attack_damage = random.randint(monster_stats[4] + monster_stats[1], monster_stats[3] + monster_stats[1]) 
